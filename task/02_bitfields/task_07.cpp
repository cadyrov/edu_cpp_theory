...
class PackedDate {
    // TODO: реализуйте битовые поля для хранения даты
    
public:
    // Конструктор по умолчанию (текущая дата)
    PackedDate() {
        // TODO: реализуйте конструктор с текущей датой
    }
    
    // Конструктор с параметрами
    PackedDate(uint16_t year, uint8_t month, uint8_t day){
        // TODO: реализуйте конструктор с проверкой корректности
    }
    ...
    static bool isLeapYear(uint16_t year) {
        // TODO: реализуйте проверку високосного года
        return false;
    }
